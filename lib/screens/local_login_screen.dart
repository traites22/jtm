...
import 'local_registration_screen.dart';
...
class _LocalLoginScreenState extends State<LocalLoginScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('JTM - Connexion Locale'),
                  ...
                  onPressed: _isLoading
                      ...
                      : () {
                          Navigator.of(context).pushReplacement(
                            MaterialPageRoute(builder: (_) => const LocalRegistrationScreen()),
                          );
                        },
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      'Version de test fonctionnant immédiatement ! Les données sont stockées localement sur ce téléphone.',
