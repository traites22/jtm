...
class LocalRegistrationScreen extends StatefulWidget {
  ...
  @override
  State<LocalRegistrationScreen> createState() => _LocalRegistrationScreenState();
}
    ...
    try {
      ...
      if (result.success) {
        if (mounted) {
          ...
          Navigator.of(
            context,
          ).pushReplacement(MaterialPageRoute(builder: (_) => const LocalLoginScreen()));
        }
      } else {
        if (mounted) {
          ScaffoldMessenger.of(
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      'Cette version utilise le stockage local pour tester rapidement. Plusieurs utilisateurs sur le même téléphone peuvent s\'inscrire et discuter entre eux !',
